        ...
        <footer class="text-white body-font bg-black">
            <div class="container px-5 py-24 mx-auto">
                <div class="flex flex-wrap md:text-left text-center order-first">
                    ...
                    <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav class="list-none mb-10">
                            <li>
                                <a class="text-gray-400 hover:text-white">484 Progress Ave</a>
                            </li>
                            <li>
                                <a class="text-gray-400 hover:text-white">Ontario</a>
                            </li>
                            <li>
                                <a class="text-gray-400 hover:text-white">Canada</a>
                            </li>
                            <li>
                                <a class="text-gray-400 hover:text-white">(444) 555-8888</a>
                            </li>
                        </nav>
                    </div>
                    <div class="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <div class="bg-black">
                <div class="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
                    ...
                    <a style={{ marginTop: "5px", margin: "auto" }} href="https://twitter.com/knyttneve" rel="noopener noreferrer" class="text-white ml-1" target="_blank">© {`${dt.getFullYear()}`} EmotionRec — @EmotionRec</a>
